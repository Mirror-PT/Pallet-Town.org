...
public class HUDButtonFactory {
        ...
        static {
                try {
                     ...
                     // -- Pokedex Buttons --
                        normals.put("pokedex", getNormalImage("pokedex"));
                        rollovers.put("pokedex", getRolloverImage("pokedex"));
                        downs.put("pokedex", getDownImage("pokedex"));
                        
                        // -- News Buttons --
                        normals.put("news", getNormalImage("news"));
                        rollovers.put("news", getRolloverImage("news"));
                        downs.put("news", getDownImage("news"));
                        ...
                        font = GameClient.getFontChatSmall();
