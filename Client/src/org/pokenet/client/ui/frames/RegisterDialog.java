...
public class RegisterDialog extends Frame{
	...
	public RegisterDialog() {
		...
		m_u.pack();
		m_u.setLocation(4, 4);
		m_u.setFont(GameClient.getFontChatSmall());
		...
		m_p.setFont(GameClient.getFontChatSmall());
		...
		m_cp.setFont(GameClient.getFontChatSmall());
		...
		m_d.setFont(GameClient.getFontChatSmall());
		...
		m_e.setFont(GameClient.getFontChatSmall());
		...
		m_ce.setFont(GameClient.getFontChatSmall());
		...
		m_s.setFont(GameClient.getFontChatSmall());
		...
		m_g.setFont(GameClient.getFontChatSmall());
		...
		m_tos.setFont(GameClient.getFontChatSmall());
	...
	private void generateStarters() {
		...
		try {
			...
			m_starters[1].setImage(new Image(f, respath+"res/pokemon/icons/004.gif", false));
			m_starters[1].setDisabledImage(new Image(f, respath+"res/pokemon/icons/004.gif", false));
			...
			m_starters[2].setImage(new Image(f, respath+"res/pokemon/icons/007.gif", false));
			m_starters[2].setDisabledImage(new Image(f, respath+"res/pokemon/icons/007.gif", false));
			...
			f = FileLoader.loadFile(respath+"res/pokemon/icons/025.gif");
			m_starters[3].setImage(new Image(f, respath+"res/pokemon/icons/025.gif", false));
			m_starters[3].setDisabledImage(new Image(f, respath+"res/pokemon/icons/025.gif", false));
			m_starters[3].setLocation(160, 54);
			...
			this.add(m_starters[3]);//pikachu
			
			f = FileLoader.loadFile(respath+"res/pokemon/icons/133.gif");
			m_starters[4].setImage(new Image(f, respath+"res/pokemon/icons/133.gif", false));
			m_starters[4].setDisabledImage(new Image(f, respath+"res/pokemon/icons/133.gif", false));
			m_starters[4].setLocation(192, 54);
			...
			this.add(m_starters[4]);//eevee
			
			f = FileLoader.loadFile(respath+"res/pokemon/icons/035.gif");
			m_starters[5].setImage(new Image(f, respath+"res/pokemon/icons/035.gif", false));
			m_starters[5].setDisabledImage(new Image(f, respath+"res/pokemon/icons/035.gif", false));
			m_starters[5].setLocation(224, 54);
			...
			this.add(m_starters[5]);//clefairy
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
				...
				if(m_email.getText() != null && this.isValidEmail(m_email.getText())
					...
					if(m_day.getText() != null && m_day.getText().length() > 0 && m_day.getText().length() < 3
						...
						if(!m_terms.isEnabled()) {
							...
							GameClient.messageDialog(translated.get(42), GameClient.getInstance().getDisplay());
						}
					} else {
