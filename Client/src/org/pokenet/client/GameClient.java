...
public class GameClient extends BasicGame {
	...
	private static Font m_fontLarge, m_fontSmall,m_fontChatLarge, m_fontChatSmall, m_trueTypeFont;
	...
	public static String serverName = "Pallet-Town.org | Kanto's Legacy";
	...
	static {
		try {
			...
			m_instance = new GameClient(serverName);
...
//		gc.getGraphics().setBackground(Color.white);
		m_loadImage = new Image("res/loadingscreen.png");
//		m_loadImage = m_loadImage.getScaledCopy(gc.getWidth() / m_loadImage.getWidth());
		 ...
		 * Setup variables
		 */
		m_fontChatLarge = new AngelCodeFont(m_filepath+"res/fonts/chatname.fnt",m_filepath+"res/fonts/chatname.png");
		m_fontChatSmall = new AngelCodeFont(m_filepath+"res/fonts/chatname-small.fnt", m_filepath+"res/fonts/chatname-small.png");
	...
	public void render(GameContainer gc, Graphics g) throws SlickException {
		g.drawImage(m_loadImage, 0, 0);
		 ...
		 if (m_nextResource != null) {
			...
			g.drawString(serverName + " is Loading. Please wait...", 10, gc.getHeight() - 90);
				...
				if(m_confirm==null){
					ActionListener yes = new ActionListener() {
						public void actionPerformed(ActionEvent arg0) {
							...
							*/
							getInstance().getPacketGenerator().closeSession();
...
//							"Could not connect to chat server.", getDisplay());
	...
	public static void main(String [] args) {
		...
		try {
			gc = new AppGameContainer(new GameClient(serverName),
					800, 600, fullscreen);
	...
	/**
	 * Returns the chat font in large
	 * @return
	 */
	public static Font getFontChatLarge() {
		return m_fontChatLarge;
	}
	...
	/**
	 * Returns the chat font in small
	 * @return
	 */
	public static Font getFontChatSmall() {
		return m_fontChatSmall;
	}
	/**
