...
public class RegistrationManager implements Runnable {
	...
	public void register(IoSession session) throws Exception {
		...
		if(m_database.connect(GameServer.getDatabaseHost(), GameServer.getDatabaseUsername(), GameServer.getDatabasePassword())) {
			 ...
			 */
			if(!(s == 1 || s == 4 || s == 7 || s == 133 || s == 25 || s == 35 || s == 252 || s == 255 || s == 258
					|| s == 387 || s == 390 || s == 393)) {
				session.write("r4");
				return;
			}
	...
	private Pokemon createStarter(int speciesIndex) throws Exception {
		...
		case 7:
			...
			break;
		case 133:
			species = PokemonSpecies.getDefaultData().getPokemonByName("Eevee");
			break;
		case 25:
			species = PokemonSpecies.getDefaultData().getPokemonByName("Pikachu");
			break;
		case 35:
			species = PokemonSpecies.getDefaultData().getPokemonByName("Clefairy");
			break;
		case 152:
